...
type PingListener interface {
	DidReceivePing(version uint8, data []byte, from id.Signatory) (Message, error)
...
type PushListener interface {
	DidReceivePush(version uint8, data []byte, from id.Signatory) (Message, error)
...
type PullListener interface {
	DidReceivePull(version uint8, data []byte, from id.Signatory) (Message, error)
...
type Callbacks struct {
	ReceivePing    func(version uint8, data []byte, from id.Signatory) (Message, error)
	ReceivePingAck func(version uint8, data []byte, from id.Signatory) error
	ReceivePush    func(version uint8, data []byte, from id.Signatory) (Message, error)
	ReceivePushAck func(version uint8, data []byte, from id.Signatory) error
	ReceivePull    func(version uint8, data []byte, from id.Signatory) (Message, error)
	ReceivePullAck func(version uint8, data []byte, from id.Signatory) error
}

func (cb Callbacks) DidReceivePing(version uint8, data []byte, from id.Signatory) (Message, error) {
...
func (cb Callbacks) DidReceivePush(version uint8, data []byte, from id.Signatory) (Message, error) {
...
func (cb Callbacks) DidReceivePull(version uint8, data []byte, from id.Signatory) (Message, error) {
